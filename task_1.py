...
def host_ping(list_ip_addresses, output_text=True, requests=2):
    ...
    for address in list_ip_addresses:
        try:
            ...
            pass
        proc = Popen(f"ping {address} -c {requests}", shell=True, stdout=PIPE)
        proc.wait()
...
if __name__ == '__main__':
    ip_addresses = ['google.com', '127.0.0.1', '192.168.0.100', '192.168.0.101']
